...
string query_courses(string message){
    ...
    ifstream courses("cs.txt");
    string course_info; 
    //increment through CS classes in message, compare to cs.txt classes
...
int main(){
    ...
    //booting up message
    printf("serverCS is up and running using UDP on port %i\n", UDP_PORT);
    while(1){
